...
//                    if (carts.get(productId).getQuantity() < 3) {
//                        int oldQuantity = carts.get(productId).getQuantity();
//                        carts.get(productId).setQuantity(oldQuantity + 2);
//                    }
//                    else if (carts.get(productId).getQuantity() < 5) {
//                        int oldQuantity = carts.get(productId).getQuantity();
//                        carts.get(productId).setQuantity(oldQuantity + 3);
//                    }
//                    else if (carts.get(productId).getQuantity() >= 5) {
//                        int oldQuantity = carts.get(productId).getQuantity();
//                        carts.get(productId).setQuantity(oldQuantity + 5);
//                    }
//                }
